...
if (serial.inWaiting()>0):
  ...
  cmd = '''curl -X POST -H "Authorization: Bearer cbedd4e12e034f279447c4d617afe28f" -H "Content-Type: application/json" -d '{ "from": "447520651713", "to": [ "918825648984" ], "body": " '''+ content + '''" }' "https://sms.api.sinch.com/xms/v1/f85ebdfc9c5048a18ce4196276e60827/batches" '''
